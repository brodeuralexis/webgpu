...
pub inline fn deinit(bind_group: BindGroup) void {
    bind_group.vtable.deinit(bind_group.ptr);
}

pub inline fn setLabel(bind_group: BindGroup, label: ?[]const u8) void {
    bind_group.vtable.set_label(bind_group.ptr, label);
}
